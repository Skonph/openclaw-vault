...
def _fetch_calendar(symbols: list[str]) -> dict:
    ...
    try:
        ...
        if r.status_code == 403:
            ...
            print('⚠️  Tradier fundamentals: 404 — corporate calendars endpoint may be disabled/deprecated by Tradier. Relying on manual overrides (KNOWN_EVENTS/KNOWN_CLEAR).')
        else:
